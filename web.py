...
import uvicorn
# Ensure get_anime_details is imported
...
# --- APP INITIALIZATION (Ye upar hona chahiye) ---
...
def details(id: int):
    ...
    if not data: raise HTTPException(status_code=404, detail="Anime not found")
    return data
